...
public class LolaSoundnessCheckerResult {
	...
	/**
	 * Parses the response attributes LoLA.
	 * @param response attributes LoLA
	 */
	 ...
	 * @return a {@link Collection} of {@link Place}s with the given names attributes the given {@link NetSystem}
	 */
	 ...
	 * @return a {@link Collection} of {@link Transition}s with the given names attributes the given {@link NetSystem}
	 */
