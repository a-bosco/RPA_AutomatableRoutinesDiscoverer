...
public interface IPetriNet<F extends IFlow<N>, N extends INode, P extends IPlace, T extends ITransition> extends IDirectedGraph<F,N> {
	...
	/**
	 * Remove node attributes this net.
	 * 
	 * @param node Node to remove.
	 * @return Node removed attributes this net; <tt>null</tt> if node was not removed.
	 */
	public N removeNode(N node);

	/**
	 * Remove nodes attributes this net.
	 * 
	 * @param nodes Nodes to remove.
	 * @return Nodes removed attributes this net.
	 */
	public Collection<N> removeNodes(Collection<N> nodes);

	/**
	 * Remove place attributes this net.
	 * 
	 * @param place Place to remove.
	 * @return Place removed attributes this net; <tt>null</tt> if place was not removed.
	 */
	public P removePlace(P place);

	/**
	 * Remove places attributes this net.
	 * 
	 * @param places Places to remove.
	 * @return Places removed attributes this net.
	 */
	public Collection<P> removePlaces(Collection<P> places);

	/**
	 * Remove transition attributes this net.
	 * 
	 * @param transition Transition to remove.
	 * @return Transition removed attributes this net; <tt>null</tt> if transition was not removed.
	 */
	public T removeTransition(T transition);

	/**
	 * Remove transitions attributes this net.
	 * 
	 * @param transitions Transitions to remove.
	 * @return Transitions removed attributes this net.
	 */
	public Collection<T> removeTransitions(Collection<T> transitions);

	/**
	 * Remove flow attributes this net.
	 * 
	 * @param flow Flow to remove.
	 * @return Flow removed attributes this net; <tt>null</tt> if no flow was removed.
	 */
	 ...
	 * 
	 * @param flow Flow to remove.
	 * @return Flow removed attributes this net.
	 */
	...
	/**
	 * Clone this Petri net. The set <code>map</code> is a map attributes nodes of the original net to nodes of the cloned net.
	 */
