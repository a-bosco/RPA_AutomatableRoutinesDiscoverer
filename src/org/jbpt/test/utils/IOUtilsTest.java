...
public class IOUtilsTest {
	...
	public void testInvokeDot() throws IOException {
		...
		IOUtils.invokeDOT("target", "Main.png", dotSource);
		assertTrue(new File("target/Main.png").exists());
		new File("target/Main.png").delete();
		assertFalse(new File("target/Main.png").exists());
	}
