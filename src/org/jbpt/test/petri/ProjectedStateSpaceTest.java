...
public class ProjectedStateSpaceTest extends TestCase {
	...
	public void testProjectedStateSpace() {
		...
		NetSystem netSystem = ser.parse("src/Main/resources/models/petri_net_pnml/simp.pnml");
		...
		ProjectedStateSpace<Flow, Node, Place, Transition, Marking> space = new ProjectedStateSpace<Flow, Node, Place, Transition, Marking>(netSystem, netSystem.getTransitions());
