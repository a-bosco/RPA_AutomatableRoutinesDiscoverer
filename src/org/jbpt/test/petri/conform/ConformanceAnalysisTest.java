...
public class ConformanceAnalysisTest {
	...
	public void testConformanceMeasures() {
		 ...
		 */
		NetSystem net = serializer.parse("src/Main/java/org/jbpt/Main/petri/conform/conf_test.pnml");
		 ...
		 */
		conformanceAnalysis.saveResults("src/org/jbpt/Main/petri/conform/conf_test.csv");
