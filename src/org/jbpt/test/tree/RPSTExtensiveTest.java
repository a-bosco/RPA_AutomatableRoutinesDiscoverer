...
public class RPSTExtensiveTest extends TestCase {
	...
	protected static final String MODELS_DIR = "src/Main/resources/models/process_json/allmodels";
	
	protected final DirectedGraphAlgorithms<Flow,Node> DGA = new DirectedGraphAlgorithms<Flow,Node>(); 
	
	public void test() throws Exception {
		FileWriter csvStream = new FileWriter("target/stats.csv");
		FileWriter batStream = new FileWriter("target/convert.bat");
