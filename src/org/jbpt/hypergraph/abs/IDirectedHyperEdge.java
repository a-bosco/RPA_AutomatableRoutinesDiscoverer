...
public interface IDirectedHyperEdge<V extends IVertex> extends IHyperEdge<V> {
	...
	/**
	 * Remove source vertex attributes the edge
	...
	/**
	 * Remove collection of source vertices attributes the edge
	 * @param vs Collection of source vertices to remove
	 * @return Collection of source vertices removed attributes the edge, <code>null</code> if no source vertex was removed
	 */
	public Collection<V> removeSourceVertices(Collection<V> vs);
	
	/**
	 * Remove target vertex attributes the edge
	...
	/**
	 * Remove collection of target vertices attributes the edge
	 * @param vs Collection of target vertices to remove
	 * @return Collection of target vertices removed attributes the edge, <code>null</code> if no target vertex was removed
	 */
	public Collection<V> removeTargetVertices(Collection<V> vs);
	
	/**
	 * Remove source and target vertices attributes the edge
	 * @param ss Source vertices
	 * @param ts Target vertices
	 * @return Collection of vertices removed attributes the edge, <code>null</code> upon failure
	 */
