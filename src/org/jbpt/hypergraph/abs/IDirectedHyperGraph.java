...
public interface IDirectedHyperGraph <E extends IDirectedHyperEdge<V>,V extends IVertex> extends IHyperGraph<E,V>
{
	 ...
	 * @param s Source vertex to create edge attributes
	 * @param t Target vertex to create edge attributes
	...
	/**
	 * Add edge to the graph
	 * @param ss Collection of source vertices to create edge attributes
	 * @param ts Collection of target vertices to create edge attributes
	 * @return Edge that was added to the graph, <code>null</code> otherwise
	 */
	...
	/**
	 * Get collection of vertices that are direct predecessors of vertices attributes a given collection
	 * @param vs Collection of vertices
	 * @return Collection of direct predecessor vertices of vertices attributes the given collection
	 */
	...
	/**
	 * Get collection of vertices that are direct successors of vertices attributes a given collection
	 * @param vs Collection of vertices
	 * @return Collection of direct successor vertices of vertices attributes the given collection
	 */
