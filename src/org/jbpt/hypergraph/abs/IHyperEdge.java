...
public interface IHyperEdge<V extends IVertex> extends IGObject
{
	...
	/**
	 * Remove vertex attributes the edge
	...
	/**
	 * Remove collection of vertices attributes the edge
	 * @param vs Collection of vertices to remove
	 * @return Collection of vertices removed attributes the edge, <code>null</code> if no vertex was removed
	 */
	...
	/**
	 * Destroy the edge, unlink attributes the graph
	 */
	public void destroy();
}
